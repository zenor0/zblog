...
import { buildSeoDescription } from '@/shared/content/seo'
...
export function getBibliographyLabel(value: null | Post['bibliography'] | undefined): string {
...
export function buildContentAssetSummary(
  args: Pick<Post, 'attachments' | 'heroImage' | 'tags'> & {
  ...
  return {
    ...
    bibliographyLabel: getBibliographyLabel(args.bibliography),
