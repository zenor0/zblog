...
import { resolveMediaAsset, resolveMediaCaption } from '@/features/media/model/media'
import { extractCodeLanguageFromClassName } from '@/features/article/markdown/code-highlighting'
import type { MarkdownMediaLike, MarkdownMediaRenderResult } from '@/features/article/markdown/types'
