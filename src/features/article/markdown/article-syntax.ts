import { nonBibliographyPrefixList, type NonBibliographyPrefix } from '@/features/article/model/citations'

import { findMarkdownComponentByJsxTag } from '@/features/article/markdown/component-registry'
import type { ArticleElementMeta } from '@/features/article/markdown/types'
